...
/**
  * _print_format - function to print the format
...
/**
  * _print_spec - function for a valid specifier
...
/**
  * _print_invalid_spec - functio for invalid specifier
...
/**
  * _validate_char - function for each type choosen
